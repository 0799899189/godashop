...
class CustomerController
{
    ...
    public function register()
    {
        ...
        $domain = get_host_name_widthout_port();
        ...
        if (!$resp->isSuccess()) {
            ...
            //  impplode là hàm nối các phần tử trong array thành1 chuỗi
        ...
        $linkActive = get_domain_site() . '?c=customer&a=active&token=' .
        $token;
        $content = "
        Dear $name, <br>
...
exit;
        ...
        $_SESSION['success'] = 'tài khoản đã kích hoạt thành công';
