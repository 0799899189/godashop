                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="?c=information&a=deliveryPolicy">Chính sách giao hàng </a></li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li>Phone: 0799.899.189</li>
                                <li><a href="mailto:anhkhoa28071999@gmail.com">Mail:
                                        anhkhoa28071999@gmail.com</a></li>
                            </ul>
                            <ul class="list-inline">
                                <li><a href="https://www.facebook.com/byn.byn.14/"><i class="fab fa-facebook-f"></i></a>
                                </li>
