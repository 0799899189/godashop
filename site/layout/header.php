            ...
            <div class="row">
                ...
                <div class="col-md-6 hidden-sm hidden-xs">
                    <ul class="list-inline">
                        <li><a href="https://www.facebook.com/byn.byn.14/"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a
                                    href="tel:0799.899.189">0799.899.189</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a
                                    href="mailto:anhkhoa28071999@gmail.com">anhkhoa28071999@gmail.com</a></span>
                        </p>
                    </div>
